...
{
  //  IFLW_REG(MOVL_A0_R); 
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVL_A0_R,REGNUM);
    A0 = (uint32_t)REG;
}
...
{
  //  IFLW_REG(ADDL_A0_R); 
  info_flow_log_op_write(IFLO_OPREG_TEMPL_ADDL_A0_R,REGNUM);
    A0 = (uint32_t)(A0 + REG);
}
...
void OPPROTO glue(glue(op_addl_A0,REGNAME),_s1)(void)
{
  ...
  info_flow_log_op_write(IFLO_OPREG_TEMPL_ADDL_A0_R_S1,REGNUM);
...
void OPPROTO glue(glue(op_addl_A0,REGNAME),_s2)(void)
{
  ...
  info_flow_log_op_write(IFLO_OPREG_TEMPL_ADDL_A0_R_S2,REGNUM);
...
void OPPROTO glue(glue(op_addl_A0,REGNAME),_s3)(void)
{
  ...
  info_flow_log_op_write(IFLO_OPREG_TEMPL_ADDL_A0_R_S3,REGNUM);
...
{
  //  IFLW_REG(MOVL_T0_R);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVL_T0_R,REGNUM);
    T0 = REG;
}
...
{
  //  IFLW_REG(MOVL_T1_R);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVL_T1_R,REGNUM);
    T1 = REG;
}
...
{
  //  IFLW_REG(MOVH_T0_R);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVH_T0_R,REGNUM);
    T0 = REG >> 8;
}
...
{
  //  IFLW_REG(MOVH_T1_R);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVH_T1_R,REGNUM);
    T1 = REG >> 8;
}
...
{
  //  IFLW_REG(MOVL_R_T0);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVL_R_T0,REGNUM);
    REG = (uint32_t)T0;
}
...
{
  //  IFLW_REG(MOVL_R_T1);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVL_R_T1,REGNUM);
    REG = (uint32_t)T1;
}
...
{
  //  IFLW_REG(MOVL_R_A0);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVL_R_A0,REGNUM);
    REG = (uint32_t)A0;
}
...
void OPPROTO glue(glue(op_cmovw,REGNAME),_T1_T0)(void)
{
  if (T0) {
    ...
    info_flow_log_op_write(IFLO_OPREG_TEMPL_CMOVW_R_T1_T0,REGNUM);
...
void OPPROTO glue(glue(op_cmovl,REGNAME),_T1_T0)(void)
{
  if (T0) {
    ...
    info_flow_log_op_write(IFLO_OPREG_TEMPL_CMOVL_R_T1_T0,REGNUM);
        REG = (uint32_t)T1;
  }
    FORCE_RET();
}
...
{
  //  IFLW_REG(MOVW_R_T0);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVW_R_T0,REGNUM);
...
{
  //  IFLW_REG(MOVW_R_T1);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVW_R_T1,REGNUM);
    REG = (REG & ~0xffff) | (T1 & 0xffff);
}
...
{
  //  IFLW_REG(MOVW_R_A0);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVW_R_A0,REGNUM);
...
{
  //  IFLW_REG(MOVB_R_T0);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVB_R_T0,REGNUM);
...
{
  //  IFLW_REG(MOVH_R_T0);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVH_R_T0,REGNUM);
...
{
  //  IFLW_REG(MOVB_R_T1);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVB_R_T1,REGNUM);
...
{
  //  IFLW_REG(MOVH_R_T1);
  info_flow_log_op_write(IFLO_OPREG_TEMPL_MOVH_R_T1,REGNUM);
