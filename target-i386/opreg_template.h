...
{
  //  IFLW_REG(MOVL_A0_R); 
  info_flow_log_op_movl_a0_r(1,REGNUM);
    A0 = (uint32_t)REG;
}
...
{
  //  IFLW_REG(ADDL_A0_R); 
  info_flow_log_op_addl_a0_r(1,REGNUM);
    A0 = (uint32_t)(A0 + REG);
}
...
void OPPROTO glue(glue(op_addl_A0,REGNAME),_s1)(void)
{
  ...
  info_flow_log_op_addl_a0_r_s1(1,REGNUM);
...
void OPPROTO glue(glue(op_addl_A0,REGNAME),_s2)(void)
{
  ...
  info_flow_log_op_addl_a0_r_s2(1,REGNUM);
...
void OPPROTO glue(glue(op_addl_A0,REGNAME),_s3)(void)
{
  ...
  info_flow_log_op_addl_a0_r_s3(1,REGNUM);
...
{
  //  IFLW_REG(MOVL_T0_R);
  info_flow_log_op_movl_t0_r(1,REGNUM);
    T0 = REG;
}
...
{
  //  IFLW_REG(MOVL_T1_R);
  info_flow_log_op_movl_t1_r(1,REGNUM);
    T1 = REG;
}
...
{
  //  IFLW_REG(MOVH_T0_R);
  info_flow_log_op_movh_t0_r(1,REGNUM);
    T0 = REG >> 8;
}
...
{
  //  IFLW_REG(MOVH_T1_R);
  info_flow_log_op_movh_t1_r(1,REGNUM);
    T1 = REG >> 8;
}
...
{
  //  IFLW_REG(MOVL_R_T0);
  info_flow_log_op_movl_r_t0(1,REGNUM);
    REG = (uint32_t)T0;
}
...
{
  //  IFLW_REG(MOVL_R_T1);
  info_flow_log_op_movl_r_t1(1,REGNUM);
    REG = (uint32_t)T1;
}
...
{
  //  IFLW_REG(MOVL_R_A0);
  info_flow_log_op_movl_r_a0(1,REGNUM);
    REG = (uint32_t)A0;
}
...
void OPPROTO glue(glue(op_cmovw,REGNAME),_T1_T0)(void)
{
  if (T0) {
    ...
    info_flow_log_op_cmovw_r_t1_t0(1,REGNUM);
...
void OPPROTO glue(glue(op_cmovl,REGNAME),_T1_T0)(void)
{
  if (T0) {
    ...
    info_flow_log_op_cmovl_r_t1_t0(1,REGNUM);
        REG = (uint32_t)T1;
  }
    FORCE_RET();
}
...
{
  //  IFLW_REG(MOVW_R_T0);
  info_flow_log_op_movw_r_t0(1,REGNUM);
...
{
  //  IFLW_REG(MOVW_R_T1);
  info_flow_log_op_movw_r_t1(1,REGNUM);
    REG = (REG & ~0xffff) | (T1 & 0xffff);
}
...
{
  //  IFLW_REG(MOVW_R_A0);
  info_flow_log_op_movw_r_a0(1,REGNUM);
...
{
  //  IFLW_REG(MOVB_R_T0);
  info_flow_log_op_movb_r_t0(1,REGNUM);
...
{
  //  IFLW_REG(MOVH_R_T0);
  info_flow_log_op_movh_r_t0(1,REGNUM);
...
{
  //  IFLW_REG(MOVB_R_T1);
  info_flow_log_op_movb_r_t1(1,REGNUM);
...
{
  //  IFLW_REG(MOVH_R_T1);
  info_flow_log_op_movh_r_t1(1,REGNUM);
