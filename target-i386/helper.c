...
//    target_ulong ssp, sp, new_eip, new_esp, sp_mask;
    target_ulong ssp, sp, new_eip, new_esp, sp_mask,  old_esp;
    

   // Xuxian
    
    //     target_ulong  regs_ebx;
    //     char *current_task, **argvp, *command, *tempbuf;
...
#ifdef IFERRET_PUID
  //  iferfffffffret_log_op_write_4444(IFLO_SPAWN_NEW_PID,current_pid,current_uid,parent_pid,parent_uid);
