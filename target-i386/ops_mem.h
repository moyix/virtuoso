...
void OPPROTO glue(glue(op_ldub, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDUB_T0_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_ldsb, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDSB_T0_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_lduw, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDUW_T0_A0,MEMSUFFINUM,A0);  
...
void OPPROTO glue(glue(op_ldsw, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDSW_T0_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_ldl, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDL_T0_A0,MEMSUFFINUM,A0);
...
//  IFLW_MEMSUFFIX_ADDR(A0,LDUB_T1_A0);
  info_flow_log_op_write(ILFO_OPS_MEM_LDUB_T1_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_ldsb, MEMSUFFIX), _T1_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDSB_T1_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_lduw, MEMSUFFIX), _T1_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDUW_T1_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_ldsw, MEMSUFFIX), _T1_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDSW_T1_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_ldl, MEMSUFFIX), _T1_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_LDL_T1_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_stb, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_STB_T0_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_stw, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_STW_T0_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_stl, MEMSUFFIX), _T0_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_STL_T0_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_stw, MEMSUFFIX), _T1_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_STW_T1_A0,MEMSUFFINUM,A0);
...
void OPPROTO glue(glue(op_stl, MEMSUFFIX), _T1_A0)(void)
{
  ...
  info_flow_log_op_write(ILFO_OPS_MEM_STL_T1_A0,MEMSUFFINUM,A0);
