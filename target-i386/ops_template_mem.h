...
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_ROL_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
...
void OPPROTO glue(glue(op_ror, MEM_SUFFIX), _T0_T1_cc)(void)
{
	...
	//	IFLW_SHIFT_MEM_WRITE(ROR_T0_T1_CC);
        ...
        T0 = (T0 >> count) | (T0 << (DATA_BITS - count));
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_ROR_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_rol, MEM_SUFFIX), _T0_T1)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(ROL_T0_T1);
        ...
        T0 = (T0 << count) | (T0 >> (DATA_BITS - count));
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_ROL_T0_T1_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_ror, MEM_SUFFIX), _T0_T1)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(ROR_T0_T1);
        ...
        T0 = (T0 >> count) | (T0 << (DATA_BITS - count));
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_ROR_T0_T1_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_rcl, MEM_SUFFIX), _T0_T1_cc)(void)
{
	...
	//	IFLW_SHIFT_MEM_WRITE(RCL_T0_T1_CC);
        ...
        T0 = res;
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_RCL_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_rcr, MEM_SUFFIX), _T0_T1_cc)(void)
{
	...
	//	IFLW_SHIFT_MEM_WRITE(RCR_T0_T1_CC);
        ...
        T0 = res;
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_RCR_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_shl, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHL_T0_T1_CC);
        ...
        T0 = T0 << count;
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_SHL_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_shr, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHR_T0_T1_CC);
        ...
        T0 = T0 >> count;
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_SHR_T0_T1_CC_MEMWRITE, SHIFT, phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_sar, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SAR_T0_T1_CC);
        ...
        src = src >> (count - 1);
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_SAR_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_shld, MEM_SUFFIX), _T0_T1_im_cc)(void)
{
    ...
    T0 = res >> 16;
#ifdef MEM_WRITE
    iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_SHLD_T0_T1_IM_CC_MEMWRITE,SHIFT,phys_a0());
    glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_shld, MEM_SUFFIX), _T0_T1_ECX_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHLD_T0_T1_ECX_CC);
        ...
        T0 = res >> 16;
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_SHLD_T0_T1_ECX_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_shrd, MEM_SUFFIX), _T0_T1_ECX_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHRD_T0_T1_ECX_CC);
        ...
        T0 = res;
#ifdef MEM_WRITE
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_SHRD_T0_T1_ECX_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_adc, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    T0 = T0 + T1 + cf;
#ifdef MEM_WRITE
    iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_ADC_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
    glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_sbb, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    T0 = T0 - T1 - cf;
#ifdef MEM_WRITE
    iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_SBB_T0_T1_CC_MEMWRITE,SHIFT,phys_a0());
    glue(st, MEM_SUFFIX)(A0, T0);
#else
...
void OPPROTO glue(glue(op_cmpxchg, MEM_SUFFIX), _T0_T1_EAX_cc)(void)
{
	...
	iferret_log_info_flow_op_write_14(IFLO_OPS_TEMPLATE_CMPXCHG_T0_T1_EAX_CC_MEMWRITE,SHIFT,phys_a0());
        glue(st, MEM_SUFFIX)(A0, T0);
#else
