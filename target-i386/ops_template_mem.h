...
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_ROL_T0_T1_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_ROL_T0_T1_CC,SHIFT);
...
void OPPROTO glue(glue(op_ror, MEM_SUFFIX), _T0_T1_cc)(void)
{
	...
	//	IFLW_SHIFT_MEM_WRITE(ROR_T0_T1_CC);
        ...
        T0 = (T0 >> count) | (T0 << (DATA_BITS - count));
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_ROR_T0_T1_CC_MEMRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_ROR_T0_T1_CC,SHIFT);
        /* gcc 3.2 workaround. This is really a bug in gcc. */
        asm volatile("" : : "r" (T0));
#endif
        CC_SRC = (cc_table[CC_OP].compute_all() & ~(CC_O | CC_C)) |
...
void OPPROTO glue(glue(op_rol, MEM_SUFFIX), _T0_T1)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(ROL_T0_T1);
        ...
        T0 = (T0 << count) | (T0 >> (DATA_BITS - count));
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_ROL_T0_T1_MEMRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_ROL_T0_T1,SHIFT);
#endif
    }
    FORCE_RET();
}
...
void OPPROTO glue(glue(op_ror, MEM_SUFFIX), _T0_T1)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(ROR_T0_T1);
        ...
        T0 = (T0 >> count) | (T0 << (DATA_BITS - count));
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_ROR_T0_T1_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_ROR_T0_T1,SHIFT);
#endif
    }
    FORCE_RET();
}
...
void OPPROTO glue(glue(op_rcl, MEM_SUFFIX), _T0_T1_cc)(void)
{
	...
	//	IFLW_SHIFT_MEM_WRITE(RCL_T0_T1_CC);
        ...
        T0 = res;
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_RCL_T0_T1_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_RCL_T0_T1_CC,SHIFT);
#endif
...
void OPPROTO glue(glue(op_rcr, MEM_SUFFIX), _T0_T1_cc)(void)
{
	...
	//	IFLW_SHIFT_MEM_WRITE(RCR_T0_T1_CC);
        ...
        T0 = res;
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_RCR_T0_T1_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_RCR_T0_T1_CC,SHIFT);
#endif
        CC_SRC = (eflags & ~(CC_C | CC_O)) |
            (lshift(src ^ T0, 11 - (DATA_BITS - 1)) & CC_O) |
            ((src >> (count - 1)) & CC_C);
...
void OPPROTO glue(glue(op_shl, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHL_T0_T1_CC);
        ...
        T0 = T0 << count;
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_SHL_T0_T1_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_SHL_T0_T1_CC,SHIFT);
#endif
        CC_SRC = src;
        CC_DST = T0;
...
void OPPROTO glue(glue(op_shr, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHR_T0_T1_CC);
        ...
        T0 = T0 >> count;
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_SHR_T0_T1_CC_MEMWRITE, SHIFT, A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_SHR_T0_T1_CC, SHIFT);
#endif
        CC_SRC = src;
        CC_DST = T0;
...
void OPPROTO glue(glue(op_sar, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SAR_T0_T1_CC);
        ...
        src = src >> (count - 1);
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_SAR_T0_T1_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_SAR_T0_T1_CC,SHIFT);
#endif
        CC_SRC = src;
        CC_DST = T0;
        CC_OP = CC_OP_SARB + SHIFT;
...
void OPPROTO glue(glue(op_shld, MEM_SUFFIX), _T0_T1_im_cc)(void)
{
    ...
    T0 = res >> 16;
#ifdef MEM_WRITE
    iferret_log_op_write_18(IFLO_SHLD_T0_T1_IM_CC_MEMWRITE,SHIFT,A0);
    glue(st, MEM_SUFFIX)(A0, T0);
#else
    iferret_log_op_write_1(IFLO_SHLD_T0_T1_IM_CC,SHIFT);
#endif
    CC_SRC = tmp;
    CC_DST = T0;
}
...
void OPPROTO glue(glue(op_shld, MEM_SUFFIX), _T0_T1_ECX_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHLD_T0_T1_ECX_CC);
        ...
        T0 = res >> 16;
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_SHLD_T0_T1_ECX_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_SHLD_T0_T1_ECX_CC,SHIFT);
#endif
        CC_SRC = tmp;
        CC_DST = T0;
        CC_OP = CC_OP_SARB + SHIFT;
...
void OPPROTO glue(glue(op_shrd, MEM_SUFFIX), _T0_T1_im_cc)(void)
{
    ...
    T0 = res;
#ifdef MEM_WRITE
    iferret_log_op_write_18(IFLO_SHRD_T0_T1_IM_CC_MEMWRITE,SHIFT,A0);
    glue(st, MEM_SUFFIX)(A0, T0);
#else
    iferret_log_op_write_1(IFLO_SHRD_T0_T1_IM_CC,SHIFT);
#endif
    CC_SRC = tmp;
    CC_DST = T0;
}
...
void OPPROTO glue(glue(op_shrd, MEM_SUFFIX), _T0_T1_ECX_cc)(void)
{
    ...
    if (count) {
      ...
      //      IFLW_SHIFT_MEM_WRITE(SHRD_T0_T1_ECX_CC);
        ...
        T0 = res;
#ifdef MEM_WRITE
	iferret_log_op_write_18(IFLO_SHRD_T0_T1_ECX_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_SHRD_T0_T1_ECX_CC,SHIFT);
#endif
        CC_SRC = tmp;
        CC_DST = T0;
        CC_OP = CC_OP_SARB + SHIFT;
...
void OPPROTO glue(glue(op_adc, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    T0 = T0 + T1 + cf;
#ifdef MEM_WRITE
    iferret_log_op_write_18(IFLO_ADC_T0_T1_CC_MEMWRITE,SHIFT,A0);
    glue(st, MEM_SUFFIX)(A0, T0);
#else
    iferret_log_op_write_1(IFLO_ADC_T0_T1_CC,SHIFT);
#endif
    CC_SRC = T1;
    CC_DST = T0;
...
void OPPROTO glue(glue(op_sbb, MEM_SUFFIX), _T0_T1_cc)(void)
{
    ...
    T0 = T0 - T1 - cf;
#ifdef MEM_WRITE
    iferret_log_op_write_18(IFLO_SBB_T0_T1_CC_MEMWRITE,SHIFT,A0);
    glue(st, MEM_SUFFIX)(A0, T0);
#else
    iferret_log_op_write_1(IFLO_SBB_T0_T1_CC,SHIFT);
#endif
    CC_SRC = T1;
    CC_DST = T0;
...
void OPPROTO glue(glue(op_cmpxchg, MEM_SUFFIX), _T0_T1_EAX_cc)(void)
{
	...
	iferret_log_op_write_18(IFLO_CMPXCHG_T0_T1_EAX_CC_MEMWRITE,SHIFT,A0);
        glue(st, MEM_SUFFIX)(A0, T0);
#else
	iferret_log_op_write_1(IFLO_CMPXCHG_T0_T1_EAX_CC,SHIFT);
#endif
    } else {
        EAX = (EAX & ~DATA_MASK) | (T0 & DATA_MASK);
	//        IFLW_CMPXCHG_T0_T1_EAX_CC(INFO_FLOW_OP_CMPXCHG_T0_T1_EAX_CC_CASE3);
	iferret_log_op_write_1(IFLO_CMPXCHG_T0_T1_EAX_CC_CASE2,SHIFT);
    }
    CC_SRC = src;
    CC_DST = dst;
    FORCE_RET();
