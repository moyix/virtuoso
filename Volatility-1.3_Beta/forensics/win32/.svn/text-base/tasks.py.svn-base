...
def create_addr_space(kaddr_space, directory_table_base):
    ...
    KUSER_SHARED_DATA_K = 0xFFDF0000
    KUSER_SHARED_DATA_U = 0x7FFE0000
    if not process_address_space.is_valid_address(KUSER_SHARED_DATA_K):
        return None
    if process_address_space.vtop(KUSER_SHARED_DATA_U) != process_address_space.vtop(KUSER_SHARED_DATA_K):
        return None
